        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-3">
            ...
            >
                ...
                <div>
                  ...
                  {watchlist.length > 0 ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-400 mb-4">Add movies to your watchlist to keep track of what you want to watch</p>
                      <button
                        onClick={() => navigate('/explore')}
                        className="btn btn-primary"
                      >
              ...
              {activeTab === 'liked' && (
                <div>
                  <h2 className="text-2xl font-bold mb-6">Liked Movies</h2>
                  ...
                  {likedMovies.length > 0 ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <h3 className="text-xl font-semibold mb-2">No Liked Movies</h3>
                      <p className="text-gray-400 mb-4">Like movies to build a collection of your favorites</p>
                      <button
                        onClick={() => navigate('/explore')}
                        className="btn btn-primary"
                      >
